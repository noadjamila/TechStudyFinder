...
export async function filterLevel2(studyProgrammeIds: number[] | undefined, answers: any[]) {
  // Implement level 2 filtering logic here
}

export async function filterLevel3(studyProgrammeIds: number[] | undefined, answers: any[]) {
